...
const Tabsbar = () => {
	return (
		<div className={styles.tabs}>
			<Tab icon='/logos/html_icon.svg' filename='index.html' path='/' />
			<Tab icon='/logos/react_icon.svg' filename='home.tsx' path='/home' />
			<Tab icon='/logos/typescript.png' filename='about.ts' path='/about' />
			<Tab
